[#node-client-workplace-search-api]
...
// ^^^ See relevant discuss thread about Workplace Search limits documentation 
// https://discuss.elastic.co/t/limits/281505
// TODO: Any ideas about how we might best present these limits, other than the above NOTE?
