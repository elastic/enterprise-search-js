...
https://github.com/elastic/enterprise-search-js/tree/8.6[`enterprise-search-js`^] is the official *Node.js* client for Elastic Enterprise Search, App Search, and Workplace Search.
